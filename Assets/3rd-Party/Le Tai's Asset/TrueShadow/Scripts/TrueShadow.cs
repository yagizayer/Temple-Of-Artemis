...
public partial class TrueShadow : UIBehaviour, IMeshModifier, ICanvasElement
{
    ...
    [SerializeField] bool multiplyCasterAlpha = true;
    ...
    /// </summary>
    public bool MultiplyCasterAlpha
    {
        get => multiplyCasterAlpha;
        set
        {
            if (modifiedFromInspector || value != multiplyCasterAlpha)
            {
                modifiedFromInspector = false;
